...
local pactl = require("core.ui.bar.top.widgets.volume.pactl")
local utils = require("core.ui.bar.top.widgets.volume.utils")


local widget_types = {
    icon_and_text = require("core.ui.bar.top.widgets.volume.styles.icon-and-text-widget"),
    icon = require("core.ui.bar.top.widgets.volume.styles.icon-widget"),
}
...
local function worker(user_args)
    ...
    if widget_types[widget_type] == nil then
        volume.widget = widget_types['icon'].get_widget(args.icon_args)
    else
